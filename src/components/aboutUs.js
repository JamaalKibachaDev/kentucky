        ...
        <div className="container">
            ...
            <div className="d-flex">
              ...
              <span>KFC</span>, or <span>Kentucky Fried Chicken</span>, has a rich history that traces back to the 1930s. It was founded by <span>Colonel Harland Sanders</span>, who began selling fried chicken from his roadside restaurant in Corbin, Kentucky, during the <span>Great Depression</span>. Sanders developed a secret blend of <span>11 herbs and spices</span> that became the hallmark of his fried chicken.
                ...
                <p className='main-intro'>In <span>1952</span>, Sanders began franchising the concept, opening the first KFC franchise in<span> Salt Lake City, Utah</span>. The brand quickly gained popularity, and by the 1960s, KFC had expanded across the United States and into other countries.</p>
            </div>

            <div className="main-intro d-flex justify-content-center my-4 px-4" >
...
{/*1*/}
        <div className="images-arrange">
            <img src={require("./images/colonel-sanders-img.webp")} alt="sanders-img" className="heritage-img d-flex mx-3 w-50"/>
